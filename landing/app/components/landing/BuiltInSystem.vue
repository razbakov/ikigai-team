        ...
        >
          ...
          <div class="pb-8">
            <div class="flex items-center gap-2 mb-1">
              ...
              <span class="text-xs px-2 py-0.5 rounded-full bg-muted text-muted-foreground">{{ t(`journey.steps.${key}.methodology`) }}</span>
            </div>
            <h3 class="text-lg font-semibold mb-1">{{ t(`journey.steps.${key}.name`) }} <span class="text-sm font-normal text-muted-foreground">{{ t('journey.with') }} {{ journeyMeta[index].agent }}</span></h3>
            <p class="text-sm text-muted-foreground">{{ t(`journey.steps.${key}.description`) }}</p>
          </div>
        </div>
      </div>
    </div>
